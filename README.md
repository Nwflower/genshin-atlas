...
在原神武器图鉴的武器效果描述中，我们直接使用了biliwiki的原神板块中的对应描述，并未意识到其文本和游戏内的实际文本有所出入，对此侵犯biliwiki创作者创作权益的行为，我深感抱歉。

复制其描述并非我个人本意，在近期的更新中，我将停止这种侵权行为，使用游戏内原本的文本，望取得biliwiki的相关创作者的谅解。

我们在此呼吁广大创作者尊重原创知识版权，保护他人的劳动果实。
